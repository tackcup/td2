...
#==============================================================================#
                if text.lower() == 'คำสั่ง':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『❌แทคสุดหล่อ❌』")
...
#=====================================================================================#                        
                   ...
                   if msg._from in admin:
                    ...
                    if targets == []:
                        line.sendMessage(to, "ไม่มีคนร่องหนในกลุ่มนี้😂")
                    else:
                        mc = ""
                        for target in targets:
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "❌แทคสุดหล่อ❌\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n❌แทคสุดหล่อ❌", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n❌แทคสุดหล่อ❌", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
        ...
        if op.type ==25 or op.type ==26:
            ...
            if settings ["Siri"] == True:
                if msg.text in ["/ตั้งแอดรอง","/ตั้งรอง","/ตั้งแอดรอง"]:
                    line.sendText(msg.to,"❌แทคสุดหล่อ❌")
